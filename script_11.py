# 11. Create templates/login.html and templates/register.html
            ...
            <div class="card shadow mt-5">
                <div class="card-body p-4">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Access your deliverability dashboard</p>
                    </div>
...
with open(f"{project_name}/templates/register.html", 'w') as f:
    f.write(register_template)

print("✅ templates/login.html created")
print("✅ templates/register.html created")