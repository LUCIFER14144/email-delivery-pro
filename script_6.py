# 6. Create utils/spam_checker.py
spam_checker_content = '''import re
import random
...
with open(f"{project_name}/utils/spam_checker.py", 'w') as f:
    f.write(spam_checker_content)

print("✅ utils/spam_checker.py created")